      ...
      <div className="legalresource">
        ...
        >
          ...
          <Typography fontSize="1rem" mt={1}>
            Understand the laws that protect against sexual violence in India.
          </Typography>
          <Typography fontSize="1rem" mt={1}>
            Get informed about your rights and legal recourse.
          </Typography>
        </div>
        <div onClick={() => navigate("/FilingOfFir")} className="FIRfiling">
          ...
          <Typography fontSize="1rem" mt={1}>
            Learn how to file a First Information Report (FIR) in India.
          </Typography>
          <Typography fontSize="1rem" mt={1}>
            All About the FIR filing process.
          </Typography>
        </div>
      </div>
    </div>
